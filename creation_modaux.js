/*Création des modaux avec les animations*/
	...
	function createModalFeu(){
		...
		var modal = $("<div></div>").attr("class","modal-content");
		//modal.append($("<span></span>").class("close").html("&times;");
		modal.append($("<img></img>").attr({"id":"feuImg", "src":"feu_rouge.png", "alt":"feu_rouge", "style" : "font-size:medium;opacity:1;left:50%;top:30%;position:absolute;float:left"}));
		modal.append($("<p></p>").attr({"id": "compteurFeu"}).html("Attendez!!!!"));
